...
passport.use(
  new RobloxStrategy(
    {
      clientID: process.env.ROBLOX_CLIENT_ID || "6748474744887863615",
      clientSecret: process.env.ROBLOX_CLIENT_SECRET || "RBX-4cu22Y7nHEGVVnrep29VdQoTsZQxHFrhhObPdjejfsKDr1f4P9K1DONn5VpcHxLL",
